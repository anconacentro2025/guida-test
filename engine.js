...
// dalla versione generale della guida.
    ...
    const APP_CACHE_NAME = 'ancona-guida-v7.3.4-751';
...
;
    ...
    function renderAnyPlaceDetail(p,index,total,isSubMode){
        ...
        // V7.3.4-751: bottoni opzionali telefono/sito, stesso pattern pillola di extraMap.
        ...
        if(p.website){btns+=' <a href="'+p.website+'" target="_blank" rel="noopener noreferrer" class="map-button" aria-label="'+tr('Sito web','Website','Webseite','Strona')+' '+getName(p)+'">🌐 '+tr('Sito','Website','Webseite','Strona')+'</a>';}
