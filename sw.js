// ===== V6.8 · 14/08/26 01:00 =====
// Service Worker — Affittacamere Ancona Centro · Guida Ospiti V6.8 14/08/26
...
self.addEventListener('fetch', (event) => {
    ...
    // V6.8: FIX — prima questa cache salvava anche le risposte di errore (es. 404 se il
    // file non era ancora stato caricato su GitHub al momento del primo tentativo), restando
    // "incollata" all'errore anche dopo che il file veniva caricato davvero. Ora si mette in
    // cache solo se response.ok, così un file mancante viene ritentato ad ogni apertura finché
    // non esiste davvero, invece di restare bloccato sul 404 per sempre.
